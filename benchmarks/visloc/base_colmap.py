...
from kapture.io.csv import kapture_from_dir, trajectories_from_file
from kapture_localization.utils.pairsfile import get_ordered_pairs_from_file
from scipy.spatial.transform import Rotation
from tqdm import tqdm

from .base_dataset import BaseVislocDataset

# from dust3r.datasets.utils.transforms import ImgNorm
from .geometry import colmap_to_opencv_intrinsics
from .utils import cam_to_world_from_kapture, get_resize_function, rescale_points3d
...
class BaseVislocColmapDataset(BaseVislocDataset):
    def __init__(
        ...
        if kdata_query.trajectories is None:
            kdata_query.trajectories = trajectories_from_file(
                os.path.join(query_path, "sensors", "trajectories.txt")
            )
